...
export const experiences = [
  ...
  },
  {
    ...
    description:
      "Création d'un site WordPress boutique largement modifié pour ne proposer que de la demande de devis.",
  ...
  },
  {
    ...
    description:
      "Création d'un site web WordPress complet, et d'un plugin sur-mesure.",
